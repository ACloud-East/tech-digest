...
const TechFilter = {
    ...
    HARD_ENT_TERMS: [
        ...
        // 赛事/体育
        'NBA','CBA','世界杯','奥运','亚运','欧冠','西甲','意甲','德甲','中超','联赛','欧联','亚冠','UFC','WWE','F1','赛车','车队','积分榜','出线','淘汰赛','半决赛','决赛','MVP','助攻王','得分王','射手王','金靴','金球','金手套','最佳阵容','夺冠','卫冕','赛季','比赛日','对阵','绝杀','逼平','补时','加时','点球','越位','红牌','黄牌','停赛','伤停','复出','转会','签约','续约','退役','球迷','奥运冠军','金牌','银牌','铜牌','季军','亚军',
        // 美妆/护肤/医美/瘦身
        ...
        // 影视/漫威/选秀/综艺（不含漫展/BW——Bilibili World等是科技展会活动，非娱乐）
        '漫威','复仇者联盟','复仇者','蜘蛛侠','钢铁侠','银河护卫队','变形金刚','迪士尼','皮克斯','剧场版','番剧','动画电影','新片','剧集','首播','影评','剧评','首映','路演','上映','开播','杀青','定档','综艺','真人秀','选秀','相声','小品','脱口秀','纪录片','演唱会','歌友会','签售会','握手会','首唱会','开嗓门',
        // 明星/艺人
