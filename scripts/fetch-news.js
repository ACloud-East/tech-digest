...
const TITLE_BLOCK_T1 = [
    ...
    // 电影/漫威/影视/漫展（除非含明确科技产品，否则归娱乐）
    '漫威','复仇者联盟','复仇者','蜘蛛侠','钢铁侠','银河护卫队','变形金刚','迪士尼','皮克斯','剧场版','番剧','动画电影','新片','剧集','首播',
    // 二次元/BW漫展/二次元盛会
    'BW2026','BW 2026','漫展','二次元','动漫展','Comiket','C100','CP30','CP展','同人展',
    // 美容仪/光学美肤/Ulike等
...
const googleNewsSources = [
    ...
    { name: '新品发布', query: '(科技 OR 数码 OR 手机 OR 芯片 OR AI OR 新能源) (新品发布 OR 发布会 OR 首发 OR 上市)', color: '#ad1457', topic: true },
